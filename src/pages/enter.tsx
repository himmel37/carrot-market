    ...
    <div className="mt-16 mx-4">
      ...
      <div className="mt-12">
        <div className="flex flex-col items-center">
          <h5 className="text-gray-500 text-center text-sm font-medium">
            Enter using:
          </h5>
          <div className="gird border-b mt-8 grid-cols-2 w-full">
            <button
              className={cls(
        ...
        <form className="flex flex-col mt-8">
          ...
          <div className="mt-1">
            {method === "email" ? (
              <input
                className="w-full appearance-none px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500"
                type="email"
                required
              />
            ) : null}
